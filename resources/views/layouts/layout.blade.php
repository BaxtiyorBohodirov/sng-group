                ...
                <div class="header-item">
                    ...
                    <div class="header-item-bottom w-100">
                        ...
                        <ul class="header-menu w-100 d-f justify-content-between">
                            <li><a href="" class="f-14 f-med text-upper link-col">Главная</a></li>
                            <li><a href="" class="f-14 f-med text-upper link-col active">О компании</a></li>
                            <li><a href="" class="f-14 f-med text-upper link-col">Продукция</a></li>
                            <li><a href="" class="f-14 f-med text-upper link-col">Покупателям</a></li>
                            <li><a href="" class="f-14 f-med text-upper link-col">Поставщикам</a></li>
                            <li><a href="" class="f-14 f-med text-upper link-col">Новости</a></li>
                            <li><a href="" class="f-14 f-med text-upper link-col">Вакансии</a></li>
                            <li><a href="" class="f-14 f-med text-upper link-col">Контакты</a></li>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="footer-menu-wrap d-f">
                        <ul class="footer-menu-1">
                            <li><a href="" class="f-14 f-med wh-col text-upper">Главная</a></li>
                            <li><a href="" class="f-14 f-med wh-col text-upper mt-1">О компании</a></li>
                            <li><a href="" class="f-14 f-med wh-col text-upper mt-1">Продукция</a></li>
                            <li><a href="" class="f-14 f-med wh-col text-upper mt-1">Покупателям</a></li>
                        </ul>
                        <div class="footer-menu-2">
                            <li><a href="" class="f-14 f-med wh-col text-upper">Поставщикам</a></li>
                            <li><a href="" class="f-14 f-med wh-col text-upper mt-1">Новости</a></li>
                            <li><a href="" class="f-14 f-med wh-col text-upper mt-1">Вакансии</a></li>
                            <li><a href="" class="f-14 f-med wh-col text-upper mt-1">Контакты</a></li>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="footer-bottom-block fx-csb">
                    <p class="f-reg">“SN Group” Все права защищены</p>
